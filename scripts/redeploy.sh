...
dfx deploy --wallet ${WALLET} --network ${NETWORK} --argument 'record {logo = ""; name = "y"; symbol = "y"; decimals = 8; total_supply = 1000000000; owner = principal "aaaaa-aa"; fee = 0; fee_to = principal "aaaaa-aa";}' token

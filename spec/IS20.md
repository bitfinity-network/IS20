...
The InfinitySwap (IS20) token standard is a fungible token standard for the Internete Comptur (IC). This standandard is an
extention of the ICRC-1 standard and also includes some methods from Ethereum's ERC20 token standard.
